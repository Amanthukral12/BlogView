...
const BlogConfig = () => {
  ...
  const [fontStyle, setFontStyle] = useState("font-Anek");
  ...
  return (
    <div className="flex xl:flex-row flex-col text-black bg-gray-100 h-screen">
      <div className="w-full xl:w-2/5 bg-white">
        <h6 className="mt-8 ml-8 font-medium text-gray-500 mb-8">
          💻 Creating cover images for your
          <br />
          <span className="ml-8">blogs is now super easy</span>
        </h6>
        ...
        <div className="w-11/12 border-2 mt-3 rounded text-center m-auto">
          <h6 className="font-semibold text-gray-600 mb-2">Background</h6>
        ...
        <div className="text-center mt-2 w-4/5 m-auto">
          <h6 className="font-semibold text-gray-600 mb-2">Font Style</h6>
          <select
            onChange={(e) => setFontStyle(e.target.value)}
            value={fontStyle}
            className="border-2 w-full h-10 p-2 mb-4 text-center"
          >
            <option>font-Oswald</option>
